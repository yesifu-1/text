...
#text_reason
os.system(fr"""python ./multi_process_script/multi_text_reason.py --n_processes 5  --engine Qwen/Qwen2.5-32B-Instruct --save_dir results/multi_process_model_gpt --input_program_file reason_sql.json --prompt_file ./prompts/text_reason_wtq.txt""")
