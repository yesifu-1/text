...
output=dict()
with open (r'D:/project/gittest.text/TbaleReasoningWithLLM/test/evaluate/wiki_Qwen2.5-32B-Instruct_2025_7_21_2129.json','r') as f:
    output = json.load(f)
    end=[]
    all=[]
    start=time.time()
    ...
    #保存结果到json文件
    with open(r'D:\\project\\gittest.text\\TbaleReasoningWithLLM\\test\\evaluate\\result\\Qwen2.5-32B_聚合.json', 'w', encoding='utf-8') as f:
